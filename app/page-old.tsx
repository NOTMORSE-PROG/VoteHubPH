      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold mb-4">{t.home.whyChoose}</h3>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle>{t.home.locationBased}</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle>{t.home.transparentInfo}</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  {t.home.transparentInfoDesc}
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle>{t.home.communityEngagement}</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  {t.home.communityEngagementDesc}
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle>{t.home.realTimeUpdates}</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle>{t.home.votingAnalytics}</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  {t.home.votingAnalyticsDesc}
                </p>
              </CardContent>
            </Card>
        ...
        <div className="bg-gradient-to-r from-primary/5 to-primary/10 rounded-2xl p-12 mb-20 border border-primary/20">
          <h3 className="text-3xl font-bold text-center mb-12">{t.home.platformCoverage}</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-4xl font-bold text-primary mb-2">17</div>
              <div className="text-sm text-muted-foreground">{t.home.regions}</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-primary mb-2">100+</div>
              <div className="text-sm text-muted-foreground">{t.home.citiesMunicipalities}</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-primary mb-2">500+</div>
              <div className="text-sm text-muted-foreground">{t.home.barangays}</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-primary mb-2">1000+</div>
              <div className="text-sm text-muted-foreground">{t.home.candidates}</div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mb-20">
          <h3 className="text-3xl font-bold mb-4">{t.home.readyToVote}</h3>
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            {t.home.readyToVoteDesc}
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/browse">
              <Button size="lg">{t.home.browseCandidates}</Button>
            </Link>
      ...
      <footer className="border-t bg-muted/30 py-12 mt-20">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <h4 className="font-bold mb-4">{t.nav.voteHubPH}</h4>
              <p className="text-sm text-muted-foreground">
                {t.home.footerTagline}
              </p>
            </div>
            <div>
              <h4 className="font-bold mb-4">{t.home.platform}</h4>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li>
                  <Link href="/browse" className="hover:bg-muted/50 px-2 py-1 rounded block">
                    {t.home.browseCandidates}
                  </Link>
                </li>
                <li>
                  <Link href="/elections" className="hover:bg-muted/50 px-2 py-1 rounded block">
                    {t.home.electionsStats}
                  </Link>
                </li>
                <li>
                  <Link href="/partylist" className="hover:bg-muted/50 px-2 py-1 rounded block">
                    {t.home.partyList}
                  </Link>
                </li>
              </ul>
            ...
            <div>
              <h4 className="font-bold mb-4">{t.home.account}</h4>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li>
                  <Link href="/login" className="hover:bg-muted/50 px-2 py-1 rounded block">
                    {t.common.signIn}
                  </Link>
                </li>
                <li>
                  <Link href="/register" className="hover:bg-muted/50 px-2 py-1 rounded block">
            ...
            <div>
              <h4 className="font-bold mb-4">{t.home.legal}</h4>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li>
                  <a href="#" className="hover:bg-muted/50 px-2 py-1 rounded block">
