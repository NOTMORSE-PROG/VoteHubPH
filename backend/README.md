...
The backend uses Laravel Sanctum bearer tokens for authentication. NextAuth
creates a short-lived Sanctum token after a verified sign-in, and the Laravel
middleware validates the hashed token before attaching the authenticated user.
